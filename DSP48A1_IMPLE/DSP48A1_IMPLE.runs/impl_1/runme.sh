...
HD_PWD='E:/Projects/Verilog/Projects/Spartan6_DSP48A1/DSP48A1_IMPLE/DSP48A1_IMPLE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log maindsp48a1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source maindsp48a1.tcl -notrace
