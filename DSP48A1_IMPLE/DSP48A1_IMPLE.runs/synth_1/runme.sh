...
HD_PWD='E:/Projects/Verilog/Projects/Spartan6_DSP48A1/DSP48A1_IMPLE/DSP48A1_IMPLE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maindsp48a1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maindsp48a1.tcl
